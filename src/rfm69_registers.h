...
// RegPacketConfig
#define RFM_REG_MASK_PACKETCONFIG_ADDRESSFILTERING 6    // 00000110
#define RFM_REG_MASK_PACKETCONFIG_CRCAUTOCLEAROFF  8
#define RFM_REG_MASK_PACKETCONFIG_CRCON            16
#define RFM_REG_MASK_PACKETCONFIG_DCFREE           96   // 01100000
#define RFM_REG_MASK_PACKETCONFIG_PACKETFORMAT     128
